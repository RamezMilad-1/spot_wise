...
class IntegrationsScreen extends StatelessWidget {
  ...
  List<_Integration> _items() => [
    const _Integration(
      Icons.map_rounded,
      'Maps — OpenStreetMap',
      'Interactive map tiles. Free, no key, working now.',
      _Status.active,
    ),
    const _Integration(
      Icons.travel_explore_rounded,
      'City search — Nominatim',
      'Worldwide geocoding for the search bar. Free, no key, working now.',
      _Status.active,
    ),
    const _Integration(
      Icons.directions_rounded,
      'Open in Google Maps',
      'Hands off to the Maps app for directions via a URL. No key needed.',
      _Status.active,
    ),
    _Integration(
    ...
    const _Integration(
      ...
      'Photos are kept on-device for now. Cloud upload needs the Firebase Blaze plan.',
      _Status.deferred,
    ),
    const _Integration(
      Icons.notifications_active_outlined,
      'Push — Firebase Cloud Messaging',
      'On-device + in-app notifications work now. Cross-device push needs FCM setup.',
      _Status.deferred,
    ),
  ];
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.bolt_rounded, color: heroFg),
